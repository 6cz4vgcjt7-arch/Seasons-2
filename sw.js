const CACHE="seasons-v115-20260628";
const ASSETS=["./","./index.html","./style.css?v=1.1.5","./storage.js?v=1.1.5","./engine.js?v=1.1.5","./ui.js?v=1.1.5","./app.js?v=1.1.5","./manifest.webmanifest","./icon.svg","./version.json"];
