...
const ASSETS=["./","./index.html","./style.css?v=1.1.0","./storage.js?v=1.1.0","./engine.js?v=1.1.0","./ui.js?v=1.1.0","./app.js?v=1.1.0","./manifest.webmanifest","./icon.svg","./version.json"];
