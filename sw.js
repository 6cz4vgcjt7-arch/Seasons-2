const CACHE="seasons-v133-20260629";
const ASSETS=["./","./index.html","./style.css?v=1.3.3","./storage.js?v=1.3.3","./engine.js?v=1.3.3","./ui.js?v=1.3.3","./app.js?v=1.3.3","./manifest.webmanifest","./icon.svg","./version.json"];
