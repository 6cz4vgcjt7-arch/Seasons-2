const CACHE="seasons-v118-20260628";
const ASSETS=["./","./index.html","./style.css?v=1.1.8","./storage.js?v=1.1.8","./engine.js?v=1.1.8","./ui.js?v=1.1.8","./app.js?v=1.1.8","./manifest.webmanifest","./icon.svg","./version.json"];
