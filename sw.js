...
const ASSETS=["./","./index.html","./style.css?v=1.1.1","./storage.js?v=1.1.1","./engine.js?v=1.1.1","./ui.js?v=1.1.1","./app.js?v=1.1.1","./manifest.webmanifest","./icon.svg","./version.json"];
