const CACHE="seasons-v132-20260629";
const ASSETS=["./","./index.html","./style.css?v=1.3.2","./storage.js?v=1.3.2","./engine.js?v=1.3.2","./ui.js?v=1.3.2","./app.js?v=1.3.2","./manifest.webmanifest","./icon.svg","./version.json"];
