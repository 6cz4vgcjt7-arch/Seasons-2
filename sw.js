const CACHE="seasons-v117-20260628";
const ASSETS=["./","./index.html","./style.css?v=1.1.7","./storage.js?v=1.1.7","./engine.js?v=1.1.7","./ui.js?v=1.1.7","./app.js?v=1.1.7","./manifest.webmanifest","./icon.svg","./version.json"];
