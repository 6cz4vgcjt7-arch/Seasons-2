const CACHE="seasons-v119-20260629";
const ASSETS=["./","./index.html","./style.css?v=1.1.9","./storage.js?v=1.1.9","./engine.js?v=1.1.9","./ui.js?v=1.1.9","./app.js?v=1.1.9","./manifest.webmanifest","./icon.svg","./version.json"];
