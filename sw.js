const CACHE="seasons-v121-20260629";
const ASSETS=["./","./index.html","./style.css?v=1.2.1","./storage.js?v=1.2.1","./engine.js?v=1.2.1","./ui.js?v=1.2.1","./app.js?v=1.2.1","./manifest.webmanifest","./icon.svg","./version.json"];
