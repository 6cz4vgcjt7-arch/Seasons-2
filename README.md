...
This is the **v1.1.7 Future Changes & Redirected Cash Flow** prototype release. It continues the founder-track PWA work and keeps the app local-only.

## What v1.1.7 includes
...
- User-controlled season recommendations after a priority reflection
