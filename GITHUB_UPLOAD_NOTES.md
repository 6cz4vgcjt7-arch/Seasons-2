...
Seasons v1.3.1 — The Attention Release

1. Upload all files to the GitHub Pages branch/root.
2. Open the app and confirm Settings shows v1.3.1 / Build 131.
...
Upload all files in this zip to replace the previous GitHub Pages build. This release keeps v1.3 data compatible while adding allocation details to new Horizon items.
